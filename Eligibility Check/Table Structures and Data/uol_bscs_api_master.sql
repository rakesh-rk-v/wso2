...
CREATE TABLE `api_master` (
  ...
  PRIMARY KEY (`api_id`),
  KEY `sub_api_id_index` (`sub_api_id`)
...
INSERT INTO `api_master` VALUES (1,'customerOnboarding','uol/customerOnboarding','1','kyc check,customer creation and contract creation','customer_onboarding','POST','JSON',NULL,NULL,NULL,'suresh','2023-12-10 08:33:28','2023-12-10 08:33:28'),(2,'Elligbility_Check','uol/elligbilityCheck','1','eligibility check','Elligbility_Check','POST','JSON',NULL,NULL,NULL,NULL,'2023-12-10 09:59:08','2023-12-10 09:59:08');
